...
import alephinfinity1.forgeblock.entity.SplitterSpiderEntity;
...
public class ModEntities {
        ...
        public static final EntityType<SvenFollowerEntity> SVEN_FOLLOWER_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "sven_follower").toString());
        
        public static final EntityType<SvenAlphaEntity> SVEN_ALPHA_TYPE = EntityType.Builder.create(
                SvenAlphaEntity::new,
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "sven_alpha").toString());

        public static final EntityType<PackEnforcerEntity> PACK_ENFORCER_TYPE = EntityType.Builder.create(
                PackEnforcerEntity::new,
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "pack_enforcer").toString());
        ...
        public static final EntityType<TarantulaBeastEntity> TARANTULA_BEAST_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "tarantula_beast").toString());
        ...
        public static final EntityType<TarantulaVerminEntity> TARANTULA_VERMIN_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "tarantula_vermin").toString());
        ...
        public static final EntityType<MutantTarantulaEntity> MUTANT_TARANTULA_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "mutant_tarantula").toString());
        ...
        public static final EntityType<DasherSpiderEntity> DASHER_SPIDER_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "dasher_spider").toString());
        ...
        public static final EntityType<SplitterSpiderEntity> SPLITTER_SPIDER_TYPE = EntityType.Builder.create(
                ...
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "splitter_spider").toString());
        
        public static final EntityType<TankZombieEntity> TANK_ZOMBIE_TYPE = EntityType.Builder.create(
                TankZombieEntity::new,
                EntityClassification.MONSTER).size(0.6f, 1.95f).build(new ResourceLocation(ForgeBlock.MOD_ID, "tank_zombie").toString());
