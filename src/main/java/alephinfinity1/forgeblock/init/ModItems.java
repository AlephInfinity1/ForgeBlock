...
public class ModItems {
	...
	public static final RegistryObject<Item> LV1_SPIDER_SPAWN_EGG = ITEMS.register("lv1_spider_spawn_egg", () -> new SpawnEggItem(ModEntities.LV1_SPIDER_TYPE, 0x221D19, 0x80000B, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> LV1_SLIME_SPAWN_EGG = ITEMS.register("lv1_slime_spawn_egg", () -> new SpawnEggItem(ModEntities.LV1_SLIME_TYPE, 0x51A03E, 0x7EBF6E, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	...
	public static final RegistryObject<Item> DASHER_SPIDER_SPAWN_EGG = ITEMS.register("dasher_spider_spawn_egg", () -> new SpawnEggItem(ModEntities.DASHER_SPIDER_TYPE, 0x221D19, 0x80000B, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> SPLITTER_SPIDER_SPAWN_EGG = ITEMS.register("splitter_spider_spawn_egg", () -> new SpawnEggItem(ModEntities.SPLITTER_SPIDER_TYPE, 0x221D19, 0x80000B, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> TARANTULA_BEAST_SPAWN_EGG = ITEMS.register("tarantula_beast_spawn_egg", () -> new SpawnEggItem(ModEntities.TARANTULA_BEAST_TYPE, 0x221D19, 0x80000B, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> TARANTULA_VERMIN_SPAWN_EGG = ITEMS.register("tarantula_vermin_spawn_egg", () -> new SpawnEggItem(ModEntities.TARANTULA_VERMIN_TYPE, 0x221D19, 0x80000B, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> PACK_ENFORCER_SPAWN_EGG = ITEMS.register("pack_enforcer_spawn_egg", () -> new SpawnEggItem(ModEntities.PACK_ENFORCER_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> SVEN_FOLLOWER_SPAWN_EGG = ITEMS.register("sven_follower_spawn_egg", () -> new SpawnEggItem(ModEntities.SVEN_FOLLOWER_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> SVEN_ALPHA_SPAWN_EGG = ITEMS.register("sven_alpha_spawn_egg", () -> new SpawnEggItem(ModEntities.SVEN_ALPHA_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> SOUL_OF_THE_ALPHA_SPAWN_EGG = ITEMS.register("soul_of_the_alpha_spawn_egg", () -> new SpawnEggItem(ModEntities.SOUL_OF_THE_ALPHA_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> PACK_SPIRIT_SPAWN_EGG = ITEMS.register("pack_spirit_spawn_egg", () -> new SpawnEggItem(ModEntities.PACK_SPIRIT_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));
	public static final RegistryObject<Item> HOWLING_SPIRIT_SPAWN_EGG = ITEMS.register("howling_spirit_spawn_egg", () -> new SpawnEggItem(ModEntities.HOWLING_SPIRIT_TYPE, 14144467, 13545366, new Item.Properties().group(ModItemGroups.FB_MOBS)));	
	...
	public static final RegistryObject<Item> LV1_ENDERMAN_SPAWN_EGG = ITEMS.register("lv1_enderman_spawn_egg", () -> new SpawnEggItem(ModEntities.LV1_ENDERMAN_TYPE, 1447446, 0, new Item.Properties().group(ModItemGroups.FB_MOBS)));
