...
public class WoodSingularityItem extends FBTieredItem {

	public WoodSingularityItem(Properties properties, FBTier tier) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent("text.forgeblock.item_desc.wood_0"));
		tooltip.add(new TranslationTextComponent("text.forgeblock.item_desc.wood_1"));
		tooltip.add(new TranslationTextComponent("text.forgeblock.item_desc.wood_2"));
		tooltip.add(new TranslationTextComponent("text.forgeblock.item_desc.wood_3"));
		tooltip.add(new TranslationTextComponent("text.forgeblock.item_desc.wood_4"));	
