...
public class RevenantChampionEntity extends Lv1ZombieEntity {
	
	public RevenantChampionEntity(EntityType<? extends ZombieEntity> type, World worldIn) {
		super(type, worldIn);
		this.setChild(false);
	}
	...
	protected void registerAttributes() {
		...
		this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(90000.0);
