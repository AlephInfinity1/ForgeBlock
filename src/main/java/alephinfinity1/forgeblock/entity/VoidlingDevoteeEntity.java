...
public class VoidlingDevoteeEntity extends EndermanEntity implements IFBEntity {
	...
	protected void registerAttributes() {
		...
		this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(12000000.0D);
