...
public class AtonedChampionEntity extends Lv1ZombieEntity {
	
	public AtonedChampionEntity(EntityType<? extends ZombieEntity> type, World worldIn) {
		super(type, worldIn);
		this.setChild(false);
	}
	...
	protected void registerAttributes() {
		...
		this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(600000.0);
