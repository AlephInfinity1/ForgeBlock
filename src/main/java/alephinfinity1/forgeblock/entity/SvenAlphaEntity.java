...
public class SvenAlphaEntity extends Lv15WolfEntity {

	public SvenAlphaEntity(EntityType<? extends WolfEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	protected void registerAttributes() {
		...
		this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(480000.0D);
		this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(2200.0D);
