...
public class VoidlingManiacEntity extends EndermanEntity implements IFBEntity {
	...
	protected void registerAttributes() {
		...
		this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(75000000.0D);
		this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(25000.0D);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new WaterAvoidingRandomWalkingGoal(this, 0.0D, 0.0F));
