...
/**
 * An edited version of vanilla AnvilScreen, with rename field and 39 limit removed.
 *
 */
@OnlyIn(Dist.CLIENT)
public class FBAnvilScreen extends ContainerScreen<RepairContainer> implements IContainerListener {
	private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("forgeblock", "textures/gui/container/forgeblock_anvil.png");
	...
	public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
		...
		return super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_);//!this.nameField.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_) && !this.nameField.canWrite() ? super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_) : true;
	}
	 ...
	 * Disabled in edited version to disable renaming.
	 */
