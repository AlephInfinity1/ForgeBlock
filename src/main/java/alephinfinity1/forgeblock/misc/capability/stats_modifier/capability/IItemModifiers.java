...
public interface IItemModifiers {
	 ...
	 * @return The map.
	 */
	Map<AbstractStatsModifier, CompoundNBT> getMap();
	
	/**
	 * Sets the modifier map.
	 * @param map The map to be set.
	 */
	void setMap(Map<AbstractStatsModifier, CompoundNBT> map);
	 ...
	 * @param nbt
	 */
	void put(AbstractStatsModifier modifier, CompoundNBT nbt);
	 ...
	 */
	CompoundNBT getData(AbstractStatsModifier modifier);
	 ...
	 */
	@Nullable
	CompoundNBT modifyData(AbstractStatsModifier modifier, CompoundNBT nbt);
	 ...
	 */
	CompoundNBT remove(AbstractStatsModifier modifier);
	 ...
	 */
	boolean isPresent(AbstractStatsModifier modifier);
	 ...
	 */
	Multimap<String, AttributeModifier> getModifiers(ItemStack stack);
