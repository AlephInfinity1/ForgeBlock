package alephinfinity1.forgeblock.tileentity;
...
public class FBEnchantingTableTileEntity extends TileEntity implements INameable, ITickableTileEntity {
   ...
   public FBEnchantingTableTileEntity() {
      super(ModTileEntityTypes.ENCHANTING_TABLE.get());
   }
